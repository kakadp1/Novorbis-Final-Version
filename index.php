    ...
    <div class="bg-light py-5">
        <div class="container">
            ...
            <div class="row align-items-center mb-5">
                <div class="col-md-6">
                    <h2 class="text-success sectionFont fw-bold mb-3" style="font-size: 4.2rem;">Turning Emissions into
                        Impact</h2>
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-md-6">
                    ...
                    <h3 class="text-success sectionFont fw-bold mb-3">The Future of Diesel Emission Control-Certified by
                        ARAI,
                        Industry Tested. </h3>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-5" style="width:1000px">
                    <div class="section__title">
                        <span class="sectionFont skew-up" style="font-size:3.2rem; font-weight: 700 !important;">Join
                            Our
                            Movement</span>
