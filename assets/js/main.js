...
(function ($) {
  ...
  var drJs = {
    ...
    swiperActivation: function (e) {
      ...
      $(document).ready(function () {
        // Left-moving Swiper (default)
        var swiperLeft = new Swiper(".mySwiper-clients-left", {
          slidesPerView: 6,
          spaceBetween: 10,
          slidesPerGroup: 1,
          loop: true,
          autoplay: {
            delay: 3000,
            reverseDirection: false, // Left direction
          },
          breakpoints: {
        ...
        // Right-moving Swiper
        var swiperRight = new Swiper(".mySwiper-clients-right", {
          slidesPerView: 6,
          spaceBetween: 10,
          slidesPerGroup: 1,
          loop: true,
