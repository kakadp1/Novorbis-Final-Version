...
<body>
  ...
  <div class="recd-container">
    ...
    <div class="recd-text">
      ...
      <p>
        Our <b>Crematorium Air Purification System (CAPS)</b> is specifically designed to address the growing pollution 
  ...
  <div class="kb-container">
    ...
    <ul class="kb-grid" role="list">
      ...
      <li class="kb-card">
        ...
        <p>Designed to operate efficiently with low energy consumption, making it cost-effective for large-scale installations.</p>
      </li>
      ...
      <li class="kb-card">
        ...
        <p>Meets the stringent requirements set by India’s National Clean Air Programme (NCAP) for crematorium operations.</p>
      </li>
...
<section class="how-it-works" style="background:#f8faf9;padding:56px 0;">
  <div class="hiw-container" style="max-width:1120px;margin:0 auto;">
    <header style="text-align:center;margin-bottom:36px;">
      ...
      <p style="color:#5b6e62;font-size:16px;margin:0 0 2px;">Advanced, multi‑stage air purification — protecting communities and honoring traditions.</p>
    </header>
    <div class="hiw-timeline-horizontal" style="display:flex;align-items:flex-start;justify-content:center;position:relative;gap:0;flex-wrap:wrap;">
      ...
      <div class="animated-line-wrap" style="position:absolute;top:50%;left:4%;right:14%;height:10px;border-radius:8px;overflow:hidden;z-index:1;transform:translateY(-50%);">
      ...
      <ol class="hiw-steps-list" style="display:flex;justify-content:space-between;align-items:flex-start;list-style:none;padding:0;margin:0;width:100%;z-index:2; margin-right: 19px; gap: 17px;">
        <!-- 1. Gas Capture -->
        <li data-aos="fade-up" style="flex:1;min-width:160px;display:flex;flex-direction:column;align-items:center;position:relative;margin:0 12px;">
          ...
          <div class="hiw-step-card" style="background:#fff;border-radius:8px;padding:17px 15px;box-shadow:0 3px 12px rgba(16,24,20,0.05);max-width:180px;">
            <h3 style="margin:0 0 5px 0;font-size:17px;color:#263529;font-weight:600;text-align:center;">1. Fume Collector</h3>
            <p style="color:#5b6e62;font-size:15px;margin:0;text-align:center;">Exhaust gases are collected from the cremation chamber.</p>
          </div>
        </li>
        <!-- 3. Dust Vortex System -->
        <li data-aos="fade-up" data-aos-delay="180" style="flex:1;min-width:160px;display:flex;flex-direction:column;align-items:center;position:relative;margin:0 12px;">
          <span style="margin-bottom:15px;display:flex;align-items:center;justify-content:center;width:40px;height:40px;border-radius:50%;background:rgba(46,139,87,.09);">
          ...
          <div class="hiw-step-card" style="background:#fff;border-radius:8px;padding:17px 15px;box-shadow:0 3px 12px rgba(16,24,20,0.05);max-width:180px;">
            <h3 style="margin:0 0 5px 0;font-size:17px;color:#263529;font-weight:600;text-align:center;">2. Dust Vortex System</h3>
            <p style="color:#5b6e62;font-size:15px;margin:0;text-align:center;">Enhances particle separation efficiency.</p>
          </div>
        </li>
        <!-- 4. Electrostatic Precipitation (ESP) -->
        <li data-aos="fade-up" data-aos-delay="270" style="flex:1;min-width:160px;display:flex;flex-direction:column;align-items:center;position:relative;margin:0 12px;">
          <span style="margin-bottom:15px;display:flex;align-items:center;justify-content:center;width:40px;height:40px;border-radius:50%;background:rgba(46,139,87,.09);">
          ...
          <div class="hiw-step-card" style="background:#fff;border-radius:8px;padding:17px 15px;box-shadow:0 3px 12px rgba(16,24,20,0.05);max-width:180px;">
            <h3 style="margin:0 0 5px 0;font-size:17px;color:#263529;font-weight:600;text-align:center;">3. Electrostatic Precipitation (ESP)</h3>
            <p style="color:#5b6e62;font-size:15px;margin:0;text-align:center;">Uses high-voltage charges to trap fine particles on collection plates.</p>
          </div>
        </li>
        <!-- 5. VapoX Gas Treatment -->
        <li data-aos="fade-up" data-aos-delay="360" style="flex:1;min-width:160px;display:flex;flex-direction:column;align-items:center;position:relative;margin:0 12px;">
          <span style="margin-bottom:15px;display:flex;align-items:center;justify-content:center;width:40px;height:40px;border-radius:50%;background:rgba(46,139,87,.09);">
          ...
          <div class="hiw-step-card" style="background:#fff;border-radius:8px;padding:17px 15px;box-shadow:0 3px 12px rgba(16,24,20,0.05);max-width:180px;">
            <h3 style="margin:0 0 5px 0;font-size:17px;color:#263529;font-weight:600;text-align:center;">4. VapoX Treatment</h3>
            <p style="color:#5b6e62;font-size:15px;margin:0;text-align:center;">Removes oils, chemicals, and toxic fumes.</p>
          </div>
        </li>
        <!-- 7. Clean Air Release -->
        <li data-aos="fade-up" data-aos-delay="540" style="flex:1;min-width:160px;display:flex;flex-direction:column;align-items:center;position:relative;margin:0 12px;">
          <span style="margin-bottom:15px;display:flex;align-items:center;justify-content:center;width:40px;height:40px;border-radius:50%;background:rgba(46,139,87,.09);">
          ...
          <div class="hiw-step-card" style="background:#fff;border-radius:8px;padding:17px 15px;box-shadow:0 3px 12px rgba(16,24,20,0.05);max-width:180px;">
            <h3 style="margin:0 0 5px 0;font-size:17px;color:#263529;font-weight:600;text-align:center;">5. Clean Air Release</h3>
            <p style="color:#5b6e62;font-size:15px;margin:0;text-align:center;">Purified air is released into the atmosphere.</p>
          </div>
        </li>
      </ol>
    </div>
